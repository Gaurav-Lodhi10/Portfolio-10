        ...
        <div className="w-full pt-[4vh] md:pt-[12vh] h-screen bg-[#0f0715] overflow-hidden relative">
            <div className="flex justify-center flex-col w-4/5 h-full mx-auto">
                <div className="grid grid-cols-1 lg:grid-cols-2 items-center gap-12">
                    <div className="flex flex-col items-start"> {/* Aligning text to the start */}
                        <h1 data-aos="fade-left" className="text-2xl md:text-3xl lg:text-4xl mb-5 text-gray-300 font-semibold">
                            I am {BaseInfo.name}
                        </h1>
                        <h1 data-aos="fade-right" data-aos-delay="100" className="text-bg text-3xl sm:text-4xl lg:text-6xl xl:7xl font-bold md:leading-[3rem] lg:leading-[3.5rem] xl:leading-[4rem] text-white">
                            {BaseInfo.position}
                        </h1>
                    ...
                    <div data-aos="zoom-in" data-aos-delay="400" className="flex justify-center items-center"> {/* Center the image container */}
                        <div className="hidden lg:block rounded-[3rem] border-blue-950 overflow-hidden">
                            <Image
